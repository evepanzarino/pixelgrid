...
export default function PixelGrid() {
  ...
  const getLogoPixelSize = () => {
    if (size.w > 1024) {
      // Desktop: max height 100px / 7 rows = 14.28px per cell
      // Convert to vw: (14.28 / viewport width) * 100
      return Math.min(1.43, (14.28 / size.w) * 100);
    }
    return 1.43; // Mobile: 10vw / 7 = 1.43vw per cell
  };

  const getTitlePixelSize = () => {
    if (size.w > 1024) {
      // Desktop: scale proportionally to logo
      return Math.min(0.75, getLogoPixelSize() * (0.75 / 1.43));
    }
...
<div className="grid-sidebar-wrapper" style={{display: "flex"}}>
      ...
      <div style={{
        ...
        <div style={{ width: "100%", textAlign: "center", paddingTop: "1vw" }}>
          <div style={{ color: "#000000", fontSize: size.w <= 1024 ? "1.5vw" : size.w > 1650 ? "14px" : "18px", marginBottom: "0.5vw" }}><b>Tools</b></div>
          <div style={{ 
            display: "grid", 
            ...
            <button
              ...
              style={{
                width: size.w <= 1024 ? "8vw" : size.w > 1650 ? "34px" : "42px",
                height: size.w <= 1024 ? "8vw" : size.w > 1650 ? "34px" : "42px",
                background: activeDrawingTool === "pencil" ? "#000" : "#fff",
                color: activeDrawingTool === "pencil" ? "white" : "black",
                border: "0.15vw solid #000000",
                padding: "0",
                cursor: "pointer",
                fontSize: size.w <= 1024 ? "4vw" : size.w > 1650 ? "14px" : "17px",
                fontWeight: "bold",
                display: "flex",
                alignItems: "center",
            ...
            <button
              ...
              style={{
                ...
                padding: "0",
                cursor: "pointer",
                fontSize: size.w <= 1024 ? "3vw" : size.w > 1650 ? "14px" : "17px",
                fontWeight: "bold",
                display: "flex",
                alignItems: "center",
                justifyContent: "center",
        ...
        <div style={{
          ...
          display: size.w <= 1024 ? "grid" : "flex",
          flexDirection: size.w <= 1024 ? "row" : "column",
          alignItems: size.w <= 1024 ? "stretch" : "center",
          justifyContent: size.w <= 1024 ? "stretch" : "center",
