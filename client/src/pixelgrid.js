        ...
        <div style={{ position: "relative" }}>
          <button
            ...
            style={{
              ...
              border: "none",
              borderBottom: size.w > 1024 ? "0.2vw solid #000" : "0vw solid #000" ,
              width: "100%",
              cursor: "pointer",
              height: "10vw",
              maxHeight: size.w > 1024 ? "100px" : "none",
...
<div className="grid-sidebar-wrapper" style={{display: "flex"}}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          marginBottom: size.w <= 1024 ? "0" : size.w >= 1025 && size.w <= 1370 ? "10vw" : size.w > 1650 ? "6vw" : "7.45vw",
          background: "#ffffff",
