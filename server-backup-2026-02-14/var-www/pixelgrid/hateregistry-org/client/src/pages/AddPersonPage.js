...
function AddPersonPage() {
  ...
  return (
    <>
      <SEOHead 
        title="Add Person - Hate Crime Registry"
        description="Add a new entry to the Hate Crime Registry"
      />
          ...
          <div className="form-section">
            ...
            <div className="form-group">
              ...
              <input
                ...
                value={formData.job}
                onChange={handleChange}
                placeholder="e.g. Teacher, Police Officer, Business Owner..."
              />
              <small>Their occupation or where they work</small>
            </div>
          </div>
