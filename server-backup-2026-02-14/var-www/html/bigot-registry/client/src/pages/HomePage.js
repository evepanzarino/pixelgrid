...
function HomePage() {
  ...
  const structuredData = {
    ...
    '@type': 'WebSite',
    name: 'Bigot Registry',
    url: 'https://evepanzarino.com/bigot-registry/',
    description: 'A searchable public registry documenting individuals who have engaged in bigoted behavior.',
    potentialAction: {
      '@type': 'SearchAction',
      target: {
        '@type': 'EntryPoint',
        urlTemplate: 'https://evepanzarino.com/bigot-registry/search?q={search_term_string}'
      },
  ...
  return (
    <>
      <SEOHead
        title="Bigot Registry - Public Accountability Database"
