...
function SEOHead({ 
  ...
  const baseUrl = 'https://evepanzarino.com/bigot-registry';
  const fullCanonical = canonical ? `${baseUrl}${canonical}` : baseUrl;
  const fullTitle = title ? `${title}` : 'Bigot Registry - Public Accountability Database';
  ...
  return (
    <Helmet>
      ...
      <meta property="og:site_name" content="Bigot Registry" />
